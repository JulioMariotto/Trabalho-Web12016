  ...
  <body style="height: 100%">
    ...
    <div class="row">
      ...
      <?php if(strcmp($edit["idUser"], $user_id) != 0 && !$prev): ?>
        ...
        <?php else: ?>
        <h1>Editar Assunto</h1><br>
        <form action="Assunto.php" method="POST">
          <div class="form-group">
            <input type="hidden" name="id" value="<?php echo $edit["idAss"] ?>">
            <label for="titulo">Nome do Assunto:</label>
            <input type="text" class="form-control" name="assunto" value="<?php echo $edit["nomeAss"] ?>" required>
          </div>
          <div class="form-group">
            <br>
            <h3>
               ...
               <?php if(mysqli_num_rows($exercicios) > 0): ?>
                  <?php while($exer = mysqli_fetch_assoc($exercicios)): ?>
                   <div class="panel-body">
                     <input type="checkbox" name="exerc[]" value="<?php echo $exer["idExe"]?>">  <?php echo $exer["titulo"]?>
                     <br>
                    </div>
               <?php endwhile; ?>
                <?php else: ?>
