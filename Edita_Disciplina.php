  ...
  <body style="height: 100%">
    ...
    <div class="row">
      ...
      <?php if(strcmp($edit["idUser"], $user_id) != 0 && !$prev): ?>
        ...
        <?php else: ?>
        <h1>Editar Disciplina</h1><br>
        <form action="Disciplina.php" method="POST">
          <div class="form-group">
            <input type="hidden" name="id" value="<?php echo $edit["idDis"] ?>">
            <label for="name">Nome da Disciplina:</label>
            <input type="text" class="form-control" name="disc" value="<?php echo $edit["nomeDis"] ?>" required>
          </div>
          <div class="form-group">
            <br>
            <h3>
