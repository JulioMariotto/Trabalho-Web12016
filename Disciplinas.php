...
if ($_SERVER["REQUEST_METHOD"] == "GET") 
{
  if($_GET["acao"] == "del")
  {
    if (isset($_GET["id"])) 
    {
      ...
      $sql = "DELETE FROM $listdis WHERE idDis = '$id'";
      ...
      $sql = "DELETE FROM $dis WHERE idDis = $id";
      if(!mysqli_query($conn,$sql))
      {
        ...
        <?php endif; ?>
          ...
          <div class="panel panel-default">
              <div class="panel-body">
                <ul class="list-group">
                  <a href="Nova_Disciplina.php">
                    <button type="button" class="btn btn-success active">Nova Disciplina
                    </button>
                  </a>
                  <br><br>
                ...
                <?php else: ?>
                  <li class="list-group-item">
                    <div class="alert alert-danger">
                      <strong>Nenhuma Disciplina No Sistema !</strong>
                    </div>
                  </li>
                <?php endif; ?>
                </ul>
